...
@section('content')
    ...
    <div class="wrapper mt-5">
        <div class="scroll-text">
            ...
            <p class="animated slideInLeft"><i class="fas fa-paw"></i> 愛犬の写真を投稿して他のユーザに公開できます。</p>
            <p class="animated slideInRight"><i class="fas fa-paw"></i> 他のユーザをフォローできます。</p>
            <p class="animated slideInLeft"><i class="fas fa-paw"></i> 写真をお気に入りとして登録できます。</p>
            <p class="animated slideInRight"><i class="fas fa-paw"></i> フィラリア予防の投薬スケジュールを登録できます。</p>
            <p class="animated slideInLeft"><i class="fas fa-paw"></i> 愛犬を登録できます。</p>
            <p class="animated slideInRight"><i class="fas fa-paw"></i> 登録した愛犬ごとに体重を記録しグラフを表示できます。</p>
            </div>
        </div>
    </div>
    </div>
